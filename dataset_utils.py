...
from medleydb import marl_utils as sox
from medleydb import MEDLEYDB_DIR
from medleydb import AUDIO_DIR
from medleydb import ANNOTATION_DIR
...
def get_files_for_instrument(instrument, dataset=None):
    """Get all files for a particular instrument from the dataset.
